...
(function() {
  var Gitlab, assert, credentials, gitlab, mock, projectId, response, userId;
  ...
  beforeEach(function() {
    mock.get = function(opts, cb) {
      if (cb) {
        return cb(null, response, [{}]);
      }
    };
    mock["delete"] = function(opts, cb) {
      if (cb) {
        return cb(null, response, [{}]);
      }
    };
    mock.post = function(opts, cb) {
      if (cb) {
        return cb(null, response, [{}]);
      }
    };
    mock.put = function(opts, cb) {
      if (cb) {
        return cb(null, response, [{}]);
      }
    };
    return mock.patch = function(opts, cb) {
      if (cb) {
        return cb(null, response, [{}]);
      }
    };
    ...
    describe('#all()', function() {
      beforeEach(function() {
        return mock.get = function(opts, cb) {
          ...
          projects = [project];
          return cb(null, response, projects);
        };
      });
    ...
    describe('#show()', function() {
      beforeEach(function() {
        return mock.get = function(opts, cb) {
          ...
          return cb(null, response, project);
        };
      });
