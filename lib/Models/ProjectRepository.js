...
(function() {
  var BaseModel, ProjectRepository,
  ...
  ProjectRepository = (function(_super) {
    ...
    ProjectRepository.prototype.listBranches = function(projectId, fn) {
      ...
      return this.get("projects/" + (parseInt(projectId)) + "/repository/branches", (function(_this) {
    ...
    ProjectRepository.prototype.showBranch = function(projectId, branchId, fn) {
      ...
      return this.get("projects/" + (parseInt(projectId)) + "/repository/branches/" + (encodeURI(branchId)), (function(_this) {
        return function(data) {
          if (fn) {
            return fn(data);
          }
    ...
    ProjectRepository.prototype.listTags = function(projectId, fn) {
      ...
      return this.get("projects/" + (parseInt(projectId)) + "/repository/tags", (function(_this) {
        return function(data) {
          if (fn) {
            return fn(data);
          }
    ...
    ProjectRepository.prototype.listCommits = function(projectId, fn) {
      ...
      return this.get("projects/" + (parseInt(projectId)) + "/repository/commits", (function(_this) {
        return function(data) {
          if (fn) {
            return fn(data);
          }
    ...
    ProjectRepository.prototype.showCommit = function(projectId, commitId, fn) {
      ...
      return this.get("projects/" + (parseInt(projectId)) + "/repository/branches/" + (parseInt(commitId)), (function(_this) {
        return function(data) {
          if (fn) {
            return fn(data);
          }
    ...
    ProjectRepository.prototype.diffCommit = function(projectId, sha, fn) {
      ...
      return this.get("projects/" + (parseInt(projectId)) + "/repository/branches/" + (parseInt(sha)), (function(_this) {
        return function(data) {
          if (fn) {
            return fn(data);
          }
    ...
    ProjectRepository.prototype.listTree = function(projectId, params, fn) {
      ...
      return this.get("projects/" + (parseInt(projectId)) + "/repository/tree", params, (function(_this) {
        return function(data) {
          if (fn) {
            return fn(data);
          }
    ...
    ProjectRepository.prototype.showFile = function(projectId, params, fn) {
      ...
      if (params.file_path && params.ref) {
        return this.post("projects/" + (parseInt(params.projectId)) + "/repository/files", params, (function(_this) {
          return function(data) {
            if (fn) {
              return fn(data);
            }
    ...
    ProjectRepository.prototype.updateFile = function(params, fn) {
      ...
      return this.put("projects/" + (parseInt(params.projectId)) + "/repository/files", params, (function(_this) {
        return function(data) {
          if (fn) {
            return fn(data);
          }
