...
(function() {
  ...
  ProjectRepository = (function(_super) {
    ...
    ProjectRepository.prototype.showBranch = function(projectId, branchId, fn) {
      ...
      return this.get("projects/" + (parseInt(projectId)) + "/repository/branches/" + (encodeURI(branchId)), function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    ProjectRepository.prototype.updateFile = function(params, fn) {
      ...
      return this.put("projects/" + (parseInt(params.projectId)) + "/repository/files", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
