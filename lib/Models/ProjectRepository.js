...
(function() {
  ...
  ProjectRepository = (function(_super) {
    ...
    ProjectRepository.prototype.protectBranch = function(projectId, branchId, fn) {
      ...
      return this.put("projects/" + (Utils.parseProjectId(projectId)) + "/repository/branches/" + (encodeURI(branchId)) + "/protect", (function(_this) {
        return function(data) {
          if (fn) {
            return fn(data);
          }
    ...
    ProjectRepository.prototype.unprotectBranch = function(projectId, branchId, fn) {
      ...
      this.debug("Projects::protectBranch()");
      return this.put("projects/" + (Utils.parseProjectId(projectId)) + "/repository/branches/" + (encodeURI(branchId)) + "/unprotect", (function(_this) {
        return function(data) {
          if (fn) {
            return fn(data);
          }
