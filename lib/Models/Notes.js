(function() {
  ...
  Notes = (function(superClass) {
    ...
    function Notes() {
      this.createForMergeRequest = bind(this.createForMergeRequest, this);
    ...
    Notes.prototype.createForMergeRequest = function(projectId, mergeRequestId, params, fn) {
      if (params == null) {
        params = {};
      }
      if (fn == null) {
      ...
      this.debug("Notes::createForMergeRequest()");
      return this.post(("projects/" + (Utils.parseProjectId(projectId)) + "/merge_requests/") + ((parseInt(mergeRequestId)) + "/notes"), params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
