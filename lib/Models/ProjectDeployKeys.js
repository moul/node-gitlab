(function() {
  ...
  ProjectKeys = (function(superClass) {
    ...
    ProjectKeys.prototype.listKeys = function(projectId, fn) {
      ...
      return this.get("projects/" + (Utils.parseProjectId(projectId)) + "/keys", fn);
    };
    ...
    ProjectKeys.prototype.getKey = function(projectId, keyId, fn) {
      ...
      return this.get("projects/" + (Utils.parseProjectId(projectId)) + "/keys/" + (parseInt(keyId)), fn);
    };
    ...
    ProjectKeys.prototype.addKey = function(projectId, params, fn) {
      ...
      return this.post("projects/" + (Utils.parseProjectId(projectId)) + "/keys", params, fn);
    };
