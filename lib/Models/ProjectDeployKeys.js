...
(function() {
  ...
  ProjectKeys = (function(_super) {
    ...
    ProjectKeys.prototype.listKeys = function(projectId, fn) {
      ...
      return this.get("projects/" + (parseInt(projectId)) + "/keys", (function(_this) {
    ...
    ProjectKeys.prototype.getKey = function(projectId, keyId, fn) {
      ...
      return this.get("projects/" + (parseInt(projectId)) + "/keys/" + (parseInt(keyId)), (function(_this) {
        return function(data) {
          if (fn) {
            return fn(data);
          }
    ...
    ProjectKeys.prototype.addKey = function(projectId, params, fn) {
      ...
      return this.post("projects/" + (parseInt(projectId)) + "/keys", params, (function(_this) {
        return function(data) {
          if (fn) {
            return fn(data);
          }
