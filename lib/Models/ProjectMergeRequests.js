...
(function() {
  var BaseModel, ProjectMergeRequests,
  ...
  ProjectMergeRequests = (function(_super) {
    ...
    ProjectMergeRequests.prototype.list = function(projectId, page, perPage, fn) {
      ...
      return this.get("projects/" + (parseInt(projectId)) + "/merge_requests?page=" + page + "&per_page=" + perPage, (function(_this) {
    ...
    ProjectMergeRequests.prototype.show = function(projectId, mergerequestId, fn) {
      ...
      return this.get("projects/" + (parseInt(projectId)) + "/merge_request/@{parseInt mergerequestId}", (function(_this) {
        return function(data) {
          if (fn) {
            return fn(data);
          }
    ...
    ProjectMergeRequests.prototype.add = function(projectId, sourceBranch, targetBranch, assigneeId, title, fn) {
      ...
      return this.post("projects/" + (parseInt(projectId)) + "/merge_requests", params, (function(_this) {
        return function(data) {
          if (fn) {
            return fn(data);
          }
    ...
    ProjectMergeRequests.prototype.update = function(projectId, mergerequestId, url, fn) {
      ...
      return this.put("projects/" + (parseInt(projectId)) + "/merge_request/" + (parseInt(mergerequestId)), params, (function(_this) {
        return function(data) {
          if (fn) {
            return fn(data);
          }
    ...
    ProjectMergeRequests.prototype.comment = function(projectId, mergerequestId, note, fn) {
      ...
      return this.post("projects/" + (parseInt(projectId)) + "/merge_request/" + (parseInt(mergerequestId)) + "/comments", params, (function(_this) {
        return function(data) {
          if (fn) {
            return fn(data);
          }
