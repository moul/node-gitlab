...
(function() {
  var BaseModel, ProjectHooks, Utils, _ref,
  ...
  ProjectHooks = (function(_super) {
    ...
    ProjectHooks.prototype.list = function(projectId, fn) {
      ...
      return this.get("projects/" + (Utils.parseProjectId(projectId)) + "/hooks", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    ProjectHooks.prototype.show = function(projectId, hookId, fn) {
      ...
      return this.get("projects/" + (Utils.parseProjectId(projectId)) + "/hooks/" + (parseInt(hookId)), function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    ProjectHooks.prototype.add = function(projectId, url, fn) {
      ...
      return this.post("projects/" + (Utils.parseProjectId(projectId)) + "/hooks", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    ProjectHooks.prototype.update = function(projectId, hookId, url, fn) {
      ...
      return this.put("projects/" + (Utils.parseProjectId(projectId)) + "/hooks/" + (parseInt(hookId)), params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    ProjectHooks.prototype.remove = function(projectId, hookId, fn) {
      ...
      return this["delete"]("projects/" + (Utils.parseProjectId(projectId)) + "/hooks/" + (parseInt(hookId)), function(data) {
        if (fn) {
          return fn(data);
        }
      });
