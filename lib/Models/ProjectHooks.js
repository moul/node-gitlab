...
(function() {
  ...
  ProjectHooks = (function(_super) {
    ...
    ProjectHooks.prototype.add = function(projectId, url, params, fn) {
      var _this = this;
      if (params == null) {
        params = null;
      }
      ...
      if (params.push_events == null) {
        params.push_events = true;
      }
      if (params.issues_events == null) {
        params.issues_events = true;
      }
      if (params.merge_requests_events == null) {
    ...
    ProjectHooks.prototype.update = function(projectId, hookId, url, params, fn) {
      var _this = this;
      if (params == null) {
        params = null;
      }
