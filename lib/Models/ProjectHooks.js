...
(function() {
  ...
  ProjectHooks = (function(_super) {
    ...
    ProjectHooks.prototype.list = function(projectId, fn) {
      ...
      return this.get("projects/" + (parseInt(projectId)) + "/hooks", (function(_this) {
    ...
    ProjectHooks.prototype.show = function(projectId, hookId, fn) {
      ...
      return this.get("projects/" + (parseInt(projectId)) + "/hooks/" + (parseInt(hookId)), (function(_this) {
        return function(data) {
          if (fn) {
            return fn(data);
          }
    ...
    ProjectHooks.prototype.add = function(projectId, url, fn) {
      ...
      return this.post("projects/" + (parseInt(projectId)) + "/hooks", params, (function(_this) {
        return function(data) {
          if (fn) {
            return fn(data);
          }
    ...
    ProjectHooks.prototype.update = function(projectId, hookId, url, fn) {
      ...
      return this.put("projects/" + (parseInt(projectId)) + "/hooks/" + (parseInt(hookId)), params, (function(_this) {
        return function(data) {
          if (fn) {
            return fn(data);
          }
    ...
    ProjectHooks.prototype.remove = function(projectId, hookId, fn) {
      ...
      return this["delete"]("projects/" + (parseInt(projectId)) + "/hooks/" + (parseInt(hookId)), (function(_this) {
        return function(data) {
          if (fn) {
            return fn(data);
          }
