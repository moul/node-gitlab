(function() {
  ...
  ProjectHooks = (function(superClass) {
    ...
    ProjectHooks.prototype.list = function(projectId, fn) {
      ...
      return this.get("projects/" + (Utils.parseProjectId(projectId)) + "/hooks", fn);
    };
    ...
    ProjectHooks.prototype.show = function(projectId, hookId, fn) {
      ...
      return this.get("projects/" + (Utils.parseProjectId(projectId)) + "/hooks/" + (parseInt(hookId)), fn);
    };
    ...
    ProjectHooks.prototype.add = function(projectId, params, fn) {
      ...
      return this.post("projects/" + (Utils.parseProjectId(projectId)) + "/hooks", params, fn);
    };
    ...
    ProjectHooks.prototype.update = function(projectId, hookId, url, fn) {
      ...
      return this.put("projects/" + (Utils.parseProjectId(projectId)) + "/hooks/" + (parseInt(hookId)), params, fn);
    };
    ...
    ProjectHooks.prototype.remove = function(projectId, hookId, fn) {
      ...
      return this["delete"]("projects/" + (Utils.parseProjectId(projectId)) + "/hooks/" + (parseInt(hookId)), fn);
    };
