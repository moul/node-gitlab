(function() {
  ...
  ProjectMilestones = (function(superClass) {
    ...
    function ProjectMilestones() {
      this.listIssues = bind(this.listIssues, this);
    ...
    ProjectMilestones.prototype.listIssues = function(projectId, milestoneId, fn) {
      if (fn == null) {
        fn = null;
      }
      this.debug("Projects::Milestones::listIssues()");
      return this.get("projects/" + (Utils.parseProjectId(projectId)) + "/milestones/" + (parseInt(milestoneId)) + "/issues", (function(_this) {
        return function(data) {
          if (fn) {
            return fn(data);
          }
