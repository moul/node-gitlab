(function() {
  ...
  ProjectMilestones = (function(superClass) {
    ...
    function ProjectMilestones() {
      ...
      this.milestonesIssues = bind(this.milestonesIssues, this);
    ...
    ProjectMilestones.prototype.milestonesIssues = function(projectId, milestoneId, fn) {
      if (fn == null) {
        fn = null;
      }
      this.debug("Projects::milestonesIssues()");
      return this.get("projects/" + (Utils.parseProjectId(projectId)) + "/milestones/" + (parseInt(milestoneId)) + "/issues?state=active", (function(_this) {
        return function(data) {
          if (fn) {
            return fn(data);
          }
