...
(function() {
  ...
  ProjectMembers = (function(_super) {
    ...
    ProjectMembers.prototype.list = function(projectId, fn) {
      ...
      return this.get("projects/" + (parseInt(projectId)) + "/members", (function(_this) {
    ...
    ProjectMembers.prototype.show = function(projectId, userId, fn) {
      ...
      return this.get("projects/" + (parseInt(projectId)) + "/members@{parseInt userId}", (function(_this) {
        return function(data) {
          if (fn) {
            return fn(data);
          }
    ...
    ProjectMembers.prototype.add = function(projectId, userId, accessLevel, fn) {
      ...
      return this.post("projects/" + (parseInt(projectId)) + "/members", params, (function(_this) {
        return function(data) {
          if (fn) {
            return fn(data);
          }
    ...
    ProjectMembers.prototype.update = function(projectId, userId, accessLevel, fn) {
      ...
      return this.put("projects/" + (parseInt(projectId)) + "/members/" + (parseInt(userId)), params, (function(_this) {
        return function(data) {
          if (fn) {
            return fn(data);
          }
    ...
    ProjectMembers.prototype.remove = function(projectId, userId, fn) {
      ...
      return this["delete"]("projects/" + (parseInt(projectId)) + "/members/" + (parseInt(userId)), (function(_this) {
        return function(data) {
          if (fn) {
            return fn(data);
          }
