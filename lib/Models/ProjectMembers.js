...
(function() {
  var BaseModel, ProjectMembers, Utils, _ref,
  ...
  ProjectMembers = (function(_super) {
    ...
    ProjectMembers.prototype.list = function(projectId, fn) {
      ...
      return this.get("projects/" + (Utils.parseProjectId(projectId)) + "/members", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    ProjectMembers.prototype.show = function(projectId, userId, fn) {
      ...
      return this.get("projects/" + (Utils.parseProjectId(projectId)) + "/members@{parseInt userId}", function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    ProjectMembers.prototype.add = function(projectId, userId, accessLevel, fn) {
      ...
      return this.post("projects/" + (Utils.parseProjectId(projectId)) + "/members", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    ProjectMembers.prototype.update = function(projectId, userId, accessLevel, fn) {
      ...
      return this.put("projects/" + (Utils.parseProjectId(projectId)) + "/members/" + (parseInt(userId)), params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    ProjectMembers.prototype.remove = function(projectId, userId, fn) {
      ...
      return this["delete"]("projects/" + (Utils.parseProjectId(projectId)) + "/members/" + (parseInt(userId)), function(data) {
        if (fn) {
          return fn(data);
        }
      });
