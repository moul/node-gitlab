(function() {
  var ApiBase, Promise, debug, querystring, slumber,
  ...
  module.exports.ApiBaseHTTP = (function(superClass) {
    ...
    ApiBaseHTTP.prototype.get = function(path, query, fn) {
      ...
      if (fn) {
        this.slumber(path).get(opts, this.fn_wrapper(fn));
        return null;
      } else {
        return new Promise((function(_this) {
          return function(resolve, reject) {
            return _this.slumber(path).get(opts, _this.fn_wrapper(function(err, ret) {
              if (err) {
                return reject(err);
              } else {
                return resolve(ret);
    ...
    ApiBaseHTTP.prototype["delete"] = function(path, fn) {
      ...
      if (fn) {
        this.slumber(path)["delete"](opts, this.fn_wrapper(fn));
        return null;
      } else {
        return new Promise((function(_this) {
          return function(resolve, reject) {
            return _this.slumber(path)["delete"](opts, _this.fn_wrapper(function(err, ret) {
              if (err) {
                return reject(err);
              } else {
                return resolve(ret);
    ...
    ApiBaseHTTP.prototype.post = function(path, data, fn) {
      ...
      if (fn) {
        this.slumber(path).post(opts, this.fn_wrapper(fn));
        return null;
      } else {
        return new Promise((function(_this) {
          return function(resolve, reject) {
            return _this.slumber(path).post(opts, _this.fn_wrapper(function(err, ret) {
              if (err) {
                return reject(err);
              } else {
                return resolve(ret);
    ...
    ApiBaseHTTP.prototype.put = function(path, data, fn) {
      ...
      opts = this.prepare_opts(data);
      if (fn) {
        this.slumber(path).put(opts, this.fn_wrapper(fn));
        return null;
      } else {
        return new Promise((function(_this) {
          return function(resolve, reject) {
            return _this.slumber(path).put(opts, _this.fn_wrapper(function(err, ret) {
              if (err) {
                return reject(err);
              } else {
                return resolve(ret);
    ...
    ApiBaseHTTP.prototype.patch = function(path, data, fn) {
      ...
      opts = this.prepare_opts(data);
      if (fn) {
        this.slumber(path).patch(opts, this.fn_wrapper(fn));
        return null;
      } else {
        return new Promise((function(_this) {
          return function(resolve, reject) {
            return _this.slumber(path).patch(opts, _this.fn_wrapper(function(err, ret) {
              if (err) {
                return reject(err);
              } else {
                return resolve(ret);
